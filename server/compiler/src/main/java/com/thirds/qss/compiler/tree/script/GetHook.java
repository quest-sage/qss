...
/**
 * Represents an <code>after get</code> hook.
 */
public class GetHook extends FuncOrHook {
    /**
    ...
    public GetHook(Range range, Token time, Token getToken, NameLiteral structName, NameLiteral fieldName, Type fieldType, FuncBlock funcBlock) {
        super(
